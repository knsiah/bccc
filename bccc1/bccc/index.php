...
<head>
    ...
    <title>Welcome to Burma Camp Computer Center</title>
    ...
    <div class="black-fill"><br /> <br />
        <div class="container">
            ...
            <section class="welcome-text d-flex justify-content-center align-items-center flex-column">
                <img src="logo.jpg">
                <h4>Welcome to Burma Camp Computer Center</h4>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-body-secondary">Burma Camp Computer Center</small></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center text-light">
                Copyright &copy; 2023 Burma Camp Computer Center. All right reserved -Kwabena Nsiah-Bota.
            </div>
